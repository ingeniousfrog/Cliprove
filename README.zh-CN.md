...
抖音下载基于 [douyin-downloader](https://github.com/jiji262/douyin-downloader) 引擎（git submodule）；Bilibili 使用 `yt-dlp` 与 `bilibili-api-python`。
...
| FFmpeg | 最新 | `brew install ffmpeg` — Bilibili 合并及部分高清流需要 |
